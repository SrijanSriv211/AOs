...
static void main(Obsidian AOs, Parser parser, List<(string cmd, string[] args)> input)
{
    ...
    //     default_values: new string[]{"Press any key to continue..."}, method: features.Pause
    // );
    ...
    //     },
    //     default_values: new string[0]{}, method: features.ModifyPrompt
    // );
    ...
    //     },
    //     min_args_length: 1, max_args_length: 3, method: features.Read
    // );
    // parser.Add(
    ...
    //     },
    //     min_args_length: 2, method: features.Commit
    // );
